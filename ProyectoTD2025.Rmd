...
author: "Yordano Rodriguez, Ivan Jimenez, Sergio Mut, Emma Espí, Julen Navarro, Nicolas Aroca"
date: "2025-03-30"
output:
  html_document:
    echo: yes
...
## 1.1 Configuración inicial: Librerías y carga de datos
...
## 1.2 Descripcion de variables
 En este apartado se presenta el análisis  detallado de las variables clave del dataset, organizado según su tipo (numéricas, categóricas, etc). Con el objetivo de visualizar mucho mas facil y entender a fondo cada una de estas variables 
...
```{r tab-mitabla, echo=FALSE}
# Crear la tabla a mano como un data frame
mi_tabla <- data.frame(
  Variables = c("Factura_simplificada", "OP", "Telefono", "Fecha", "Hora", "Calle", "C.Postal", "Municipio", "Total", "Pago_Tarjeta", "Parking", "ParkingEntrada", "ParkingSalida", "TarjetaUlt4", "Tipo_Tarjeta", "NC", "AUT", "AID", "ARC", "Base_Imponible_Total", "Cuota_Total", "Importe_Final", "IVA_Tipos", "IVA_Bases", "IVA_Cuotas", "Producto", "Cantidad", "Peso_kg", "PesoUnitario", "PrecioKg", "Importe"),
  Tipos = c("Character", "Character", "Numeric", "Date", "hms", "Character", "Character", "Character", "Numeric", "Numeric", "Character (binario)", "hms", "hms", "Character", "Character", "Character", "Character", "Character", "Character", "Numeric", "Numeric", "Numeric", "Character", "Character", "Character", "Character", "Numeric", "Numeric", "Numeric", "Numeric", "Numeric"),
  Descripción = c("Código del ticket", "OP", "Teléfono del supermercado", "Fecha de compra", "Hora de compra", "Calle donde se encuentra el supermercado", "Código postal del municipio donde se encuentra el supermercado", "Municipio donde se encuentra el supermercado", "Total de la compra", "Pago realizado con tarjeta", "Si se ha utilizado o no el parking", "Hora de entrada al parking", "Hora de salida del parking", "Ultimos 4 dígitos de la tarjeta bancaria", "Tipo de tarjeta bancaria utilizada", "NC", "AUT", "AID", "ARC", "Precio sin IVA", "IVA", "Precio con IVA", "Tipos de IVA aplicados", "Bases sobre las que se imponen los distintos tipos de IVA", "IVA aplicado a sus bases imponibles correspondientes", "Nombre del producto", "Cantidad del producto comprada", "Peso en kg de los productos por peso", "Peso por unidad de los productos", "Precio de los productos por peso", "Precio del producto")
)

# Mostrarla con caption
knitr::kable(mi_tabla, caption = "Variables de los data frames")
```
Como se muestra en la Tabla \@ref(tab-mitabla), estas son las variables utilizadas, sus tipos (dominios) y a qué hacen referencia.
